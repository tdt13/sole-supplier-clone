...
// This is the BlogItem component which gets rendered
//  inside the Blog section of the site; has reusable
// functionality for making adding new content easier
// pulls in img title content and author info from the
// Blog component
