...
const Footer = () => {
  return (
    ...
    <a href="https://thesolesupplier.co.uk/" target="_blank" rel="noopener noreferrer" className='text-red-400 no-underline ' >Link to SoleSupplier Site</a>
    </div>
      ...
      <FontAwesomeIcon icon={faInstagram} className="text-[#b7b7b8] size-[25px] pr-2 cursor-pointer"/>
      <FontAwesomeIcon icon={faTwitter} className="text-[#b7b7b8]  size-[25px] pr-2 cursor-pointer"/>
      <FontAwesomeIcon icon={faFacebook} className="text-[#b7b7b8]  size-[25px] pr-2 cursor-pointer"/>
      <FontAwesomeIcon icon={faYoutube} className="text-[#b7b7b8]  size-[25px] pr-2 cursor-pointer"/>
      </div>
      ...
      <div>
        <h3 className='footer-h3'>Get the latest releases, dates, news and your<br></br> favourite brands on The Sole Supplier app.</h3>
        <img src={applestore} alt='applestore' className='cursor-pointer pb-10 pt-3'></img>
        <h4 className='footer-registry'>© 2024 TomTurnerDev® . All rights Reserved® Company Reg No. 123456</h4>
      </div>
      </div>
    </div>
    </div>
